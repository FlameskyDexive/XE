...
""";
    ...
    public void Critical_Shaders_Have_Dual_Sources()
    {
        ...
        [
            ...
            DefaultShader.Grid,
            DefaultShader.Gizmos,
            DefaultShader.GizmoIcon,
            DefaultShader.DefaultUI,
            DefaultShader.DefaultText,
            DefaultShader.DefaultTextMesh,
            DefaultShader.Sprite,
            DefaultShader.Line,
            DefaultShader.Particle,
            DefaultShader.UI,
    ...
    public void Modern_Default_Passes_Compile_For_Modern_Backends_When_Dxc_Is_Available()
    {
        ...
        [
            ...
            (DefaultShader.Gizmos, "Gizmos"),
            (DefaultShader.GizmoIcon, "GizmoIcon"),
            (DefaultShader.DefaultUI, "DefaultUI"),
            (DefaultShader.DefaultText, "DefaultText"),
            (DefaultShader.DefaultTextMesh, "DefaultTextMesh"),
            (DefaultShader.Sprite, "Sprite"),
            (DefaultShader.Line, "Line"),
            (DefaultShader.Particle, "Particle"),
